...
sorgu2 = f"SELECT yorumID, elestirmenID, yildizSayisi, yorum FROM filmyorum WHERE filmID = {secimID}"
imlec2.execute(sorgu2)
veriler2 = imlec2.fetchall()
tablo2 = PrettyTable()
tablo2.field_names = ["Yorum ID", "Eleştirmen ID", "Yıldız Sayısı", "Yorum"]
